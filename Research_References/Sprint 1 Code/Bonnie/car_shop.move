module car::car_shop {
    ...
    struct ShopOwnerCap has key {iu: UID}
    ...
    public entry fun colelct_profits(_: &ShopOwnerCap, shop: &mut CarShop, ctx: &mut TxContext) {
        let amount = balnce::value(&shop.balance);
