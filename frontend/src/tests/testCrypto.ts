...
export function generateSharedSecret(aPriv: Uint8Array, bPub: Uint8Array): string {
 ...
 */
export function encrypt(message: string | null, sharedSecretHex: string): string {
  if (!message) return "";
 ...
 * The sharedSecret is expected to be a hex string.
 */
export function decrypt(encryptedText: string | null, sharedSecretHex: string): string {
